...
enddate<-c("2015-04-30","2016-04-30","2017-04-30","2018-04-30","2019-04-30","2020-04-30","2021-04-30","2021-12-30")
treatmentlist <-c ("Kunming","Changsha","Wuhan","Hefei","Chengdu","Lhasa","Guiyang","Xuzhou","Suqian","Zhuzhou","Xiangtan","Yuxi","Deyang","Qujing","Mianyang")
intervention <-c ("12-01","11-15","12-01","11-15","12-01","11-01","12-01","11-15","11-15","11-15","11-15","12-01","12-01","12-01","12-01")
  ...
  for (m in 1:length(treatmentlist)){
    ...
    test3 <- test2 %>% 
      filter(test2$ID == treat |
               test2$ID == "Dongguan"| test2$ID == "Zhongshan" |test2$ID=="Lishui" | test2$ID == "Foshan"| test2$ID == "Beihai"|
               test2$ID == "Nanning"|  test2$ID=="Nanchang" | test2$ID == "Xiamen"| test2$ID == "Taizhou"| test2$ID == "Jiaxing"|
               ...
               test2$ID == "Zhanjiang" |test2$ID == "Chaozhou"|test2$ID == "Yangjiang"| test2$ID == "Maoming")
    it_day<-intervention[m]
...
write.csv(data_exp,"alternative_result.csv",row.names = FALSE)